...
namespace _1Lab.Scripts.SignalSystem
{
    ...
    {
        [FormerlySerializedAs("gameConfiguration")] [SerializeField, HideInInspector] private OneLabConfiguration oneLabConfiguration;
        public Signal Signal => oneLabConfiguration.Signal;
