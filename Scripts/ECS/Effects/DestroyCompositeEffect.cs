...
namespace Exerussus._1Lab.Scripts.ECS.Effects
{
    ...
    {
        public void DestroyCompositeToOrigin(int originEntity, Componenter<IOneLabEcsData> componenter)
        {
        ...
        public void DestroyCompositeToOrigin(int originEntity, int targetEntity, Componenter<IOneLabEcsData> componenter)
        {
            if (!componenter.Has<CompositeObjectData>(originEntity)) return;
            ref var compositeData = ref componenter.Get<CompositeObjectData>(originEntity);
            compositeData.Value.DestroyComposite();
        ...
        public void DestroyCompositeToTarget(int originEntity, int targetEntity, Componenter<IOneLabEcsData> componenter)
        {
